        ...
        <>
            ...
            <Row className="justify-content-md-center g-6">
                <Col className="button-col mt-2 mb-5">
                    <Button href="/recipes" className="mx-4 custom-button">My Recipes</Button>
                    <Button href="/recipes/add" className="mx-4 custom-button">Add Recipe</Button>
                    <Button href="/recipes/search" className="mx-4 custom-button">Search</Button>
                </Col>
            </Row>
